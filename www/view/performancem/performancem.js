angular.module('App')
.controller('PerformancemController', function ($scope, $http, $state, $stateParams, Chats) {

  $scope.chats = Chats.get($stateParams.chatId);
  $scope.performs = Chats.getpf($stateParams.chatId);
  //console.log($scope.performs);
  //console.log($stateParams);
  //console.log($scope.chats);

  $scope.changePerformancem = function(){
    $state.go('tabs.performancem', {});
  };
